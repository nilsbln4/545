...
Reference: testfiles/data/testout_1.4.csv
Output:    functional_tests/outputs/testout_1.4.csv
Run:       python functional_tests/test_1_4.py
"""
...
def main() -> bool:
    x = load("test1.csv")
    out = rl.missing_cov(x, skip_miss=False, method="cor")
