"""Test 5.2 -- Normal simulation, PSD input, 100,000 draws.

Input:     testfiles/data/test5_2.csv
Reference: testfiles/data/testout_5.2.csv
Output:    functional_tests/outputs/testout_5.2.csv
Run:       python functional_tests/test_5_2.py
...
def main() -> bool:
    ...
    return run(
        "5.2",
        "Normal simulation, PSD input, 100,000 draws",
        result,
        "testout_5.2.csv",
        tol=MONTE_CARLO,
        reference=cov,
