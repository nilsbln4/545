...
Reference: testfiles/data/testout_1.1.csv
Output:    functional_tests/outputs/testout_1.1.csv
Run:       python functional_tests/test_1_1.py
"""
...
def main() -> bool:
    x = load("test1.csv")
    out = rl.missing_cov(x, skip_miss=True, method="cov")
